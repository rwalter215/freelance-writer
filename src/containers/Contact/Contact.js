            ...
            <Segment className='form' inverted>
              <Form onSubmit={this.handleSubmit} inverted>
                <Form.Group widths='equal'>
                  ...
                  <Form.Input required label='Email' placeholder='Email' name='emailAddress' type='email' value={emailAddress} onChange={this.handleChange}/>
                </Form.Group>
                <Form.Input label='Subject' placeholder='Subject' name='emailSubject' value={emailSubject} onChange={this.handleChange}/>
                <TextArea required autoHeight placeholder='What can I do for you?' name='emailContent' value={emailContent} onChange={this.handleChange} style={{
                  minHeight: 100
                }}/>
                {this.handleSuccess()}
